...
class _HomeTabPageState extends State<_HomeTabPage> {
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                _buildDetailRow('Device Status', _isConnected ? 'Connected' : 'Disconnected', Icons.bluetooth_connected),
                                const SizedBox(height: 12),
                                _buildDetailRow('Device Name', _deviceName, Icons.devices_other),
                                const SizedBox(height: 12),
                                _buildDetailRow('Relationship Status', _relationshipStatus, Icons.link),
                              ],
                            ),
                          ),
                          const SizedBox(height: 20),
                          ...
                          _buildActionButton(
                            ...
                            () {
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    title: Text('Forget Device', style: TextStyle(color: AppColors.textPrimary)),
                                    content: Text('Are you sure you want to forget $_deviceName?', style: TextStyle(color: AppColors.textSecondary)),
                                    actions: [
                                      TextButton(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: label == 'Device Status' && value == 'Connected' ? Colors.green : AppColors.textPrimary,
            ),
          ),
        ],
      ),
      ...
      child: Column(
        ...
        children: [
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              _isConnected ? 'Wristband Connected' : 'Wristband Disconnected',
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.w500,
                                color: _isConnected ? Colors.green : Colors.orange,
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildStatCard('Signal', 'Strong', Icons.signal_cellular_alt),
                  ],
                ),
              ],
            ),
          ...
          Expanded(
            child: ListView(
              children: [
                _buildActivityCard('SOS Alert Sent', '10:15 PM', Icons.warning, Colors.red),
                const SizedBox(height: 12),
                _buildActivityCard('New Connection', 'Yesterday', Icons.person_add, Colors.green),
                const SizedBox(height: 12),
                _buildActivityCard('Wristband Paired', '2 days ago', Icons.bluetooth_connected, Colors.blue),
              ],
            ),
          ),
        ],
  ...
  Widget _buildStatCard(String title, String value, IconData icon) {
    return Container(
      width: MediaQuery.of(context).size.width * 0.4 - 20, // Half of 40% width minus padding
      child: Column(
        children: [
                    ...
                    leading: Stack(
                      children: [
                        CircleAvatar(
                          radius: 28,
                          backgroundColor: AppColors.surface,
                          child: Icon(chat['avatar'], color: AppColors.black, size: 20),
                        ),
                        if (chat['isOnline'])
                          Positioned(
                            right: 0,
            ...
            children: [
              ...
              FloatingActionButton.extended(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const SosAlertScreen(), fullscreenDialog: true),
                  );
                },
                backgroundColor: Colors.red,
                foregroundColor: Colors.white,
                icon: Icon(Icons.warning, size: 20),
                label: Text('SOS', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                elevation: 4,
                shape: RoundedRectangleBorder(
...
class _NudgesTabPageState extends State<_NudgesTabPage> with TickerProviderStateMixin {
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: Container(
                      ...
                      child: Icon(Icons.person, color: AppColors.black, size: 18),
                    ),
                    title: Text(users[index]['name']!, style: TextStyle(color: AppColors.textPrimary)),
                    subtitle: Text(users[index]['status']!, style: TextStyle(color: AppColors.textSecondary)),
                    trailing: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        IconButton(
                          icon: Icon(Icons.chat, color: AppColors.black, size: 20),
                          onPressed: () {},
                        ),
                        IconButton(
                          icon: Icon(Icons.favorite_border, color: AppColors.textSecondary, size: 20),
                          onPressed: () {},
                        ),
                      ],
                    ),
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text(users[index]['name']!, style: TextStyle(color: AppColors.textPrimary)),
                    subtitle: Text(users[index]['status']!, style: TextStyle(
...
class _ProfileTabContentState extends State<_ProfileTabContent> {
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items: <String>['Single', 'In a relationship', 'Married', 'Divorced', 'Widowed']
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSectionCard('Basic Information', [
                  ...
                  _buildInfoRow('Bio', 'Software engineer passionate about technology and innovation'),
                ]),
                const SizedBox(height: 16),
                // About Me section with drawer-style expansion
                _buildDrawerSection('About Me', [
                  _buildDrawerItem('Interests', 'Technology, Travel, Photography, Cooking, Reading', Icons.favorite),
                  _buildDrawerItem('Dislikes', 'Noise, Rudeness, Punctuality issues, Littering', Icons.thumb_down),
                  _buildDrawerItem('Icebreakers', 'What\'s your favorite travel destination? What books are you reading? What\'s your hobby? What music do you enjoy? What are your weekend plans?', Icons.question_answer),
                ]),
                const SizedBox(height: 16),
                // Location section
                ...
                _buildSectionCard('Privacy Settings', [
                  _buildPrivacySettingRow('Profile Access', _profileAccess, (String? newValue) {
                    setState(() {
                      _profileAccess = newValue!;
                    });
                  }),
                  const SizedBox(height: 12),
                  _buildPrivacySettingRow('Location Access', _locationAccess, (String? newValue) {
                    setState(() {
                      _locationAccess = newValue!;
                    });
                  }),
                  const SizedBox(height: 12),
                  _buildPrivacySettingRow('Photo Access', _photoAccess, (String? newValue) {
                    setState(() {
  ...
  Widget _buildPrivacySettingRow(String label, String currentValue, void Function(String?) onChanged) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(
